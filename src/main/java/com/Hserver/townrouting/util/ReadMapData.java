package com.Hserver.townrouting.util;
...
public class ReadMapData {
    ...
    public void process() {
        ...
        try {
            // JSON 파일 읽기
            JsonNode rootNode = objectMapper.readTree(new File("/Users/ksnghyk/Downloads/town-routing/src/main/java/edges_data.json")); // 절대 경로
